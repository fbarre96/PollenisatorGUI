...
class ChildDialogFixView:
    ...
    def __init__(self, parent, fixModel=None):
        ...
        self.title_entry = CTkEntry(appFrame, width=50)
        ...
        self.execution_combo = CTkComboBox(appFrame, values=tuple(["Quick Win", "Moderate", "Arduous"]),state="readonly")
        ...
        self.synthesis_txt = CTkTextbox(detailedFrame, height=3)
        self.synthesis_txt.pack(fill="x")
        self.synthesis_txt.insert(tk.INSERT, fixModel.get("synthesis", "Synthesis"))
        self.description_txt = CTkTextbox(detailedFrame, height=7)
