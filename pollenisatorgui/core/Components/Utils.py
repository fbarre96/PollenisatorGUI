...
def setStyle(tkApp, _event=None):
    ...
    style.configure("Colored.TButton", background="#73B723",
                     foreground="white", font=('Sans', '10', 'bold'), borderwidth=0)
    style.layout("Colored.TButton", [('Colored.button', {'sticky': 'nswe', 'children': [('Button.padding', {'sticky': 'nswe', 'children': [('Button.label', {'expand': '1', 'sticky': 'nswe'})]})]})])
