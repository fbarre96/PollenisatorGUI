...
from pollenisatorgui.core.Components.mongo import MongoCalendar
from pollenisatorgui.core.Components.Utils import loadServerConfig, saveServerConfig, getValidMarkIconPath, getBadMarkIconPath, getWaitingMarkIconPath
...
class ChildDialogConnect:
    ...
    def __init__(self, parent, displayMsg="Connect to backend:"):
        ...
        self.rvalue = None
        self.parent = parent
        self.clientCfg = loadServerConfig()
