...
class CheckItem(Element):
    ...
    def __init__(self, valuesFromDb=None):
        ...
        self.initialize(valuesFromDb.get("title"), valuesFromDb.get("pentest_types", []), valuesFromDb.get("description", ""), valuesFromDb.get("category", ""),\
    ...
    def initialize(self, title, pentest_types=None, description="", category="", check_type="manual", step=0, parent=None, commands=None, script="", defects=None, infos=None):
    ...
    def getData(self):
        return {"_id": self._id,  "title":self.title, "pentest_types":self.pentest_types, "description": self.description, "category":self.category,
