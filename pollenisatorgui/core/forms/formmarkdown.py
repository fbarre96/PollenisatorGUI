...
#         self.mdFrame = TkintermdFrame(parent.panel, default_text="", just_editor=self.just_editor, style_change=False, enable_preview=self.enable_preview, height=self.getKw("height", 0))
#         if dark_mode:
